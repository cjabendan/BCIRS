 ...
 * @author SCC-COLLEGE
 */
public class Admin_Privacy extends javax.swing.JFrame {

    /**
     * Creates new form admin_dashboard
     */
    public Admin_Privacy() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Privacy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Privacy().setVisible(true);
            }
        });
    }
