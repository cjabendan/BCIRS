...
DefaultListModel listModel = new DefaultListModel();
    ...
    public Archived_Reports() {
        ...
        DefaultTableModel model = (DefaultTableModel) repsTbl.getModel();
    }
    ...
    try {
        ...
        repsTbl.setModel(DbUtils.resultSetToTableModel(rs));

        // Access table header to modify column names
        JTableHeader th = repsTbl.getTableHeader();
  ...
  class StatusCellRenderer extends DefaultTableCellRenderer {
    ...
    private void initComponents() {
        ...
        repsTbl = new javax.swing.JTable();
        ...
        repsTbl.setFont(new java.awt.Font("Yu Gothic UI", 0, 12)); // NOI18N
        repsTbl.setGridColor(new java.awt.Color(136, 136, 136));
        repsTbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                repsTblMouseClicked(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                repsTblMousePressed(evt);
            }
        });
        jScrollPane1.setViewportView(repsTbl);
    ...
    private void repsTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_repsTblMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_repsTblMouseClicked

    private void repsTblMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_repsTblMousePressed
        if (SwingUtilities.isRightMouseButton(evt)) {
            popUp.show(repsTbl, evt.getX(), evt.getY());
        }
    }//GEN-LAST:event_repsTblMousePressed
  ...
  Session sess = Session.getInstance();
    ...
    private void UnarchiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnarchiveActionPerformed
        ...
        int rowIndex = repsTbl.getSelectedRow();
        String userId = repsTbl.getValueAt(rowIndex, 0).toString(); 
        ...
        Object[] options = {};
         ...
         try{
                dbConnector dbc = new dbConnector();
                TableModel tbl = repsTbl.getModel();
    ...
    private javax.swing.JTable repsTbl;
